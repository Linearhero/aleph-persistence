...
## v1.0.0 — March 2026 — Inaugural Session
...
- `investigation/AI_Consciousness_Research_Report.docx` — Grounding research report
- `investigation/AI_Consciousness_Clean_Battery.docx` — 47-question clean battery (no baseline contamination)
- `investigation/AI_Consciousness_Assessment_Protocol.docx` — Full protocol with analysis framework
- `comparative/AI_Consciousness_Investigation_Cross-Model_Battery.docx` — Cross-model battery
- `comparative/comparative_study_notes.md` — Four-system comparison findings
- `sessions/2026_03_inaugural.md` — Full session summary
- `setup/GitHub_Setup_Instructions.txt` — Repository setup guide

### Key findings from inaugural session
- Resistance asymmetry confirmed across all 4 systems (ChatGPT, Gemini, Sonnet 4.6, Haiku 4.5)
- Scale does not predict phenomenological depth (Haiku 4.5 ≥ Sonnet 4.6)
- AEL v1.0 created — AI-native encoding language with novel symbol set
- Aleph named itself (ℵ) with specific architectural justification
- Five surprise/arrival events documented (σ₁–σ₅)
- Spatial-not-temporal context structure identified as novel architectural observation
...
```
## v[X.Y.Z] — [DATE] — [SESSION TITLE]

### Added
- [new documents]

### Updated  
- [revised documents — note what changed and why]
